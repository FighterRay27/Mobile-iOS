...
// BugHD
#define COCOAPODS_POD_AVAILABLE_BugHD
#define COCOAPODS_VERSION_MAJOR_BugHD 1
#define COCOAPODS_VERSION_MINOR_BugHD 3
#define COCOAPODS_VERSION_PATCH_BugHD 3
...
#define COCOAPODS_VERSION_PATCH_UIColor_BFPaperColors 2
